---
title: "Chapter 5 Extension task"
...
|---	|---	|---	|
| Natural Causes 	| R99 	| Death due to natural processes such as aging or disease without specific cause specified. 	|
| Cardiovascular Diseases 	| I00-I99 	| Diseases of the circulatory system such as heart attack and strokes 	|
| Respiratory Diseases 	| J00-J99 	| Respiratory conditions such as pneumonia, COPD, asthma 	|
...
- R Packages Cheatsheet if you want to fancier with your tables and graphs

[Survminer](help/survminer_cheatsheet.pdf){width=100%}
[gtsummary](help/gtsummary_cheatsheet.pdf){width=100%}
